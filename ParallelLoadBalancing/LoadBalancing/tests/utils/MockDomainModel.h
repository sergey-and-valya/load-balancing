...
#ifndef _MOCKDOMAINMODEL_H
#define _MOCKDOMAINMODEL_H

#include <LoadBalancing/IDomainModel.h>
#include <functional>

class MockDomainModel : public IDomainModel
{
public:
	...
	MockDomainModel (LoadProblemFunction loadProblemImpl, RunFunction runImpl)
